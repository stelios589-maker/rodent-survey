...
with st.expander("Step 4 - Food Sources"):
    ...
    tears_bird  = st.radio("If stored in bags, are there any tears or holes in the bags?", ("Yes","No"), key="tears_bird")
    sealed_bird = st.radio("If stored in plastic containers, are the containers completely sealed?", ("Yes", "No"))
    ...
    tears_grass = st.radio("If stored in bags, are there any tears or holes in the bags?", ("Yes","No"), key="tears_grass")
    sealed_grass = st.radio("If stored in plastic containers, are the containers completely sealed?", ("Yes", "No"))
