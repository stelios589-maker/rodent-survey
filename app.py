...
with st.expander("Step 4 - Food Sources"):
    ...
    tears_bird = st.radio("If stored in bags, are there any tears or holes in the bags?", ("Yes", "No"))
    ...
    tears_grass = st.radio("If stored in bags, are there any tears or holes in the bags?", ("Yes", "No"))
